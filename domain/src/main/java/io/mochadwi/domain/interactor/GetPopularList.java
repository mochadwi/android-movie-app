 ...
 */
public class GetPopularList extends UseCase<List<Movie>, Void> {

    private final MovieRepository movieRepository;

    @Inject
    GetPopularList(MovieRepository movieRepository, ThreadExecutor threadExecutor,
    ...
    Observable<List<Movie>> buildUseCaseObservable(Void unused) {
        return this.movieRepository.populars();
    }
}
